...
thinking in April of 2017.</p>

<p className = "blogContent">I wanted to be a teacher and was enrolled in the education program. All of a sudden, one
night while alone in my living room, I didn’t want to be a teacher.</p>

<p className = "blogContent">I don’t know why it happened or what made it change, but something in my brain told me that I couldn’t be a teacher and I started to have a panic attack. I tried to
fight it, convince myself that I could stand in front of a room full of adolescents and lecture them on stuff I wasn’t
passionate about.</p>

<p className = "blogContent">Eventually, my mind won the battle and that sent me on a three month spiral that would last until
...
everything was going to be okay and no plan for what my next steps would be to climb back into normalcy.</p>

<p className = "blogContent">My six brothers (yes, six) and one sister (yes...one) tried to cheer me up and tell me that they were in the same situation
...
<p className = "blogContent">He heard my story and my whole doom and gloom attitude and that my world is over, when he said this to me,
...
least try something new when I had no motivation to discover anything at all.</p>

<p className = "blogContent">Dan the programmer showed me FreeCodeCamp, a wonderful site that teaches programming for free and I believe that new and experienced programmers should check it
...
I wanted to be a programmer.</p>

<p className = "blogContent">Everything was going to be okay. That Friday night and Saturday night in June of 2017 was
