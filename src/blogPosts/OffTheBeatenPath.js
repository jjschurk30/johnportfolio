...
JavaScript by the time the first day of Fall classes began at UMSL.</p>

<p className = "blogContent">Interestingly, the first day of the semester fell on August 21st, the day of the big Solar Eclipse of 2017. I look back at that moment when the moon passed in front of
...
credits at the time and if I wanted to graduate within my 5th year of university.</p>

<p className = "blogContent">If I went back and switched to a CS degree, I probably would still be at UMSL right now and extended my stay. See, I hated college with a deep passion.
...
myself as well if I didn’t finish what I started.</p>

<p className = "blogContent">I had to prove to myself that I could complete and conquer something
that I thought in my mind was the evil enemy that must be destroyed (Yes...that’s how I actually viewed what college
was).</p>

<p className = "blogContent">I decided that if I could self-teach myself coding, I could take programming centered classes at UMSL as well
...
stupid reason, I wanted to get into comedy.</p>

<p className = "blogContent">I did a couple open mics. Some went great, some crashed into the side of
...
<p className = "blogContent">I had lost all motivation and I was back in the position where I was a year ago. I didn’t know
...
in my life. I didn’t even think I wanted to live.</p>

<p className = "blogContent">The moon had blocked the sun and cast a darkness. The next four
